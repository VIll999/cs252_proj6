...
# Project:  proj6.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile proj6.pro CONFIG+=debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_PRINTSUPPORT_LIB -DQT_CHARTS_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
Makefile: proj6.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		proj6.pro
	$(QMAKE) -o Makefile proj6.pro CONFIG+=debug
